...
**Last refreshed:** 2026-08-29T08:20Z

**Approve:** https://login.tailscale.com/a/1d0d805013867

Remint chain (do **not** use older links): `184ff33a` → `e064be30` → `6ad13a30` → **`1d0d8050`** (live). Forever `up --timeout=0s` armed. Tip through **#152** (FALLBACK pin tip#151; DONE requires live inventory; #150 SEED reject). **Ignore retired** predecessors + `80d5b860`, `7a69b1a0`, …
