...
Soft #123/#124 refresh @ ~21:15Z (HARD=0) minted **7a69b1a0**. Tip **#125** now skips soft remint while this AuthURL stays advertised — approve **this** URL. Retired `1f410a53` (and older).
...
Tip through **#125**. Expect `zombie=1 zombie_passes=3`. Success = GitHub #1 `## Downstream DONE` + RAL-793 inventory.
