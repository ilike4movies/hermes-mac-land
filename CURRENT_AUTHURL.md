...
**Last refreshed:** 2026-08-29T14:21Z

**Approve:** https://login.tailscale.com/a/1d0d805013867

Remint chain (do **not** use older links): `184ff33a` → `e064be30` → `6ad13a30` → **`1d0d8050`** (live). Forever `up --timeout=0s` armed. Tip through **#163** (ICS soft-hold tip-pin; #162 STALL/ONLY; #161 ENABLE git-push; FALLBACK `b2b5fc4` tip159). **Ignore retired** predecessors + `80d5b860`, `7a69b1a0`, …
...
Expect `zombie=1 zombie_passes=3` + tip through **#163**. Success = GitHub #1 machine `## Downstream DONE @ <ts>` + `host=` + **live** RAL-793 inventory (not SEED/`pending`/deferred).
