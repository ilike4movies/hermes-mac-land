...
## Live stall — run `2954673` (CLAIMED @ 23:25Z 2026-08-26, silent ~41h+)
...
| 6 | Operator docs | **DONE** — tip through #119 (curl|bash/ONE-SHOT-safe downstream entrypoint; soft restart young-up guard; sudo kill; hard AuthURL rotate) |
