...
| 6 | Operator docs | **DONE** — tip through #123 (AuthURL soft keep-alive default; ONE-SHOT pin to #120 entrypoint; tip-CDN pin fallback; curl|bash-safe entrypoint; soft restart young-up guard; sudo kill) |
