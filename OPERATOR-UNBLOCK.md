...
| 6 | Operator docs | **DONE** — tip through #121 (ONE-SHOT pin to #120 entrypoint; tip-CDN pin fallback; curl|bash-safe entrypoint; soft restart young-up guard; sudo kill; hard AuthURL rotate) |
