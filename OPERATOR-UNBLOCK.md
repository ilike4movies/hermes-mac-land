...
| 6 | Operator docs | **DONE** — tip through #118 (curl|bash/ONE-SHOT-safe downstream entrypoint; soft restart young-up guard; sudo kill; hard AuthURL rotate) |
