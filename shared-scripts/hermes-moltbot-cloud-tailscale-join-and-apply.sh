...
# Continuations split for MCP size limits; sourced in order.
# shellcheck disable=SC1091
source "$SCRIPT_DIR/hermes-join-part-a.sh"
source "$SCRIPT_DIR/hermes-join-part-b.sh"
source "$SCRIPT_DIR/hermes-join-part-c.sh"
