...
Tip through **#160** on main (Downstream DONE GitHub post: timed `gh` + curl/token fallback; #155 NAG DONE@ts; #154 prose reject). STALL/ONE-SHOT still prefer tip-first fetch.
